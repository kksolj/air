<template>
  <a-card :bordered="false">
    ...
    <!-- 表单区域 -->
    <goods-modal ref="goodsModal" @ok="modalFormOk"></goods-modal>
  </a-card>
</template>
  ...
  export default {
    ...
    methods: {
      ...
      handleEdit: function(record){
        this.$refs.goodsModal.edit(record);
        this.$refs.goodsModal.title="编辑";
      },
      handleAdd: function(){
        this.$refs.goodsModal.add();
        this.$refs.goodsModal.title="新增";
      },
